  ...
  return (
    <div className="w-full overflow-hidden rounded-xl border border-white/10 bg-[#1e1e1e] text-xs shadow-2xl ring-1 ring-black/40">
      ...
      {SPREADSHEET_ROWS.map((row) => (
        <div
          key={row.id}
          className={`grid grid-cols-[36px_1fr_100px_80px] border-b border-white/[0.04] text-[11px] transition-colors ${
            row.active
        ...
        >
          <div
            className={`border-r border-white/[0.04] py-2.5 text-center font-mono ${
              row.active ? "text-emerald-400" : "text-white/20"
            }`}
          >
            {row.id}
          </div>
          ...
          <div
            className={`border-r border-white/[0.04] px-3 py-2.5 text-right font-mono ${
              row.active ? "text-emerald-300 font-bold" : ""
            }`}
          >
            {row.revenue}
          </div>
