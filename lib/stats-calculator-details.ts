...
export const STATS_DETAILS: Record<StatisticsSlug, StatsCalculatorDetail> = {
  "weighted-average-grade-calculator": {
    metaDescription:
      "Free weighted average grade calculator — enter your grades and percentage weights to instantly see your final course grade, with the formula and step-by-step work.",
    formula: "Weighted grade = Σ(gradeᵢ × weightᵢ) ÷ Σ(weightᵢ)",
    whenToUse: [
      "When your syllabus gives each assignment a different share of the final grade — a Final Exam worth 50%, Homework 10%, Quizzes 20% and so on.",
      "Any time a plain average would be wrong: three easy quizzes and one hard exam do not deserve equal influence on the result.",
    ],
    howToUse: [
      "Enter each grade you have received so far.",
      "Enter the percentage weight each one carries in the course.",
      "Read your weighted average grade — add remaining items as they arrive to project your final grade.",
    ],
    example: {
      title: "Example: three graded items",
      body: "Grades 85 (20%), 90 (30%) and 78 (50%): (85×20 + 90×30 + 78×50) ÷ 100 = 4150 ÷ 100... exactly 83.00%. Press “Reset to example” above to reproduce it.",
    },
